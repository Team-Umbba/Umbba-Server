...
public class ParentchildController {
    ...
    public ApiResponse<OnboardingInviteResponseDto> onboardInvite(@Valid @RequestBody OnboardingInviteRequestDto request, Principal principal) {
...
//        Long userId = JwtProvider.getUserFromPrincial(principal);
    ...
    @ResponseStatus(HttpStatus.OK)
    public ApiResponse<OnboardingReceiveResponseDto> onboardReceive(@Valid @RequestBody OnboardingReceiveRequestDto request, Principal principal) {
